...
public class GerarPlanilhaFin implements AcaoRotinaJava {
    ...
    public void doAction(ContextoAcao contextoAcao) throws Exception {
        ...
        try {
            ...
            sql.appendSql("SELECT NOMECAMPO FROM TDDCAM WHERE NOMETAB = 'TSCE_IMPFINLAN' AND NOMECAMPO NOT IN ('DTALTER', 'CODUSU', 'MENSAGEM', 'STATUSIMP', 'DHPROCESSAMENTO', 'DATA_IMPORTACAO') ORDER BY NUCAMPO");
